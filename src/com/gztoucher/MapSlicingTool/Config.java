...
public class Config {
    ...
    public static int pointTopLeftX = 20;// 左上角屏幕X坐标
    public static int pointTopLeftY = 28;// 左上角屏幕Y坐标
    ...
    public static int pointBottomRightX = 1348;// 右下角屏幕X坐标
    public static int pointBottomRightY = 389;// 右下角屏幕Y坐标
